...
| --- | --- | --- |
| `api.md` | file | Main class for wrapping language models with intervention capabilities. |
| `tutorials.md` | file | Load a model, access internal activations, and analyze them. |
<!-- PKBLLM_TABLE_END -->
