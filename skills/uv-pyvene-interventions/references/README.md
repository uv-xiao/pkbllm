...
| --- | --- | --- |
| `api.md` | file | The core class that wraps PyTorch models for intervention. |
| `tutorials.md` | file | Swap activations between two prompts to test causal relationships. |
<!-- PKBLLM_TABLE_END -->
