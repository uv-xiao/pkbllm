...
| --- | --- | --- |
| `api.md` | file | The core class for mechanistic interpretability, wrapping transformer models with hooks on every activation. |
| `tutorials.md` | file | Understand how to load models, cache activations, and inspect model internals. |
<!-- PKBLLM_TABLE_END -->
