...
| --- | --- | --- |
| `aaai2026/` | dir | > **📝 重要说明 / Important Notice**: 本仓库借助Cursor在AAAI 2026官方模板基础上改进得到。如果遇到不满足或有冲突的情况，请积极提issues。 > > **📝 Important Notice**: This repository is improved based on the official AAAI 2026 template with the assistance of Cursor. |
| `acl/` | dir | This directory contains the latest LaTeX templates for *ACL conferences. |
| `colm2025/` | dir | Template and style files for CoLM 2025 |
| `iclr2026/` | dir |  |
| `icml2026/` | dir |  |
| `neurips2025/` | dir |  |
<!-- PKBLLM_TABLE_END -->
